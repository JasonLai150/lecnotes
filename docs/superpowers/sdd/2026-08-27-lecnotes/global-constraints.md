...
- Commit after every task. End every commit message with a `Co-Authored-By: Claude <model name> <noreply@anthropic.com>` line naming the model that authored the commit, followed by this line verbatim:
