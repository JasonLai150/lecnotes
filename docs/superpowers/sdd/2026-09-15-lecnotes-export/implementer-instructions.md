...
You are implementing one task of `lecnotes`, a Python CLI that turns one lecture deck (.pdf/.pptx) into a self-contained workdir a coding agent reads to write a teaching document, plus commands that validate, assemble, and export the result (HTML, Notion zip).

Work from: /Users/jasonlai150/Documents/GitHub/lecnotes

All paths below are in /Users/jasonlai150/Documents/GitHub/lecnotes/docs/superpowers/sdd/2026-09-15-lecnotes-export/ . Your dispatch message tells you the task number N.
