...
Also create an empty `src/lecnotes/templates/__init__.py` so `lecnotes.templates` is a
regular package; importlib.resources handles regular packages consistently across
editable, wheel, and zip installs.
